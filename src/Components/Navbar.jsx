...
const Navbar = () => {
  ...
  return (
    <>
      {" "}
      <nav
        className={`fixed w-full top-0  z-100 flex justify-between  items-center px-6 md:px-12 py-2 transition-all duration-300 ease-in-out ${
          isScrolled ? "bg-white shadow-md" : "bg- backdrop:backdrop-blur-2xl"
        }`}
      >
        {/* Logo */}
        <div className="flex items-center">
          <a href="/">
            <img
              src="https://qleen.bold-themes.com/demo-01/wp-content/uploads/sites/2/2019/02/logo_black.png"
              alt="Logo"
